...
// Стартуем 4 спринт. Надо внести доработки, чтобы
// выполнялись тесты 14 и 15 инкрементов:
// 1) Доработаем функционал авторизации под ТЗ;
// 2) Доработать функционал БД и хендлера для работы с авторизацией.
